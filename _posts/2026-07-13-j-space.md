...
\mathbf{h}*{\ell}^{(J)}
\approx
\sum*{w \in \mathcal{A}*{\ell}}
\alpha*{\ell,w}\mathbf{j}_{\ell,w},
$$
...
\alpha_{\text{soccer}}\mathbf{j}*{\ell,\text{soccer}}
+
\alpha*{\text{rugby}}\mathbf{j}_{\ell,\text{rugby}}.
$$
...
\nabla_{\mathbf{h}*{\ell}}
\log p(w_1,w_2,\ldots,w_k \mid \mathbf{h}*{\ell}).
$$
