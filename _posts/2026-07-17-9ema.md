...
The original report referenced an equity-curve comparison between the SPY and BTC 9EMA strategies and their respective buy-and-hold results. For GitHub Pages, place the corresponding image at the following path:

```markdown
![9EMA equity-curve comparison](/assets/images/ema_equity_curves.png)
```
...
For GitHub Pages, the original drawdown image can be referenced as:

```markdown
![9EMA drawdown curves](/assets/images/ema_drawdown_curves.png)
```
...
For GitHub Pages, the original intraday cost-sensitivity chart can be referenced as:

```markdown
![BTC intraday timeframe and cost sensitivity](/assets/images/ema_intraday_cost_sensitivity.png)
```
...
The original report's parameter-sensitivity chart can be referenced as:

```markdown
![Daily EMA length sensitivity](/assets/images/ema_param_sensitivity_daily.png)
```
