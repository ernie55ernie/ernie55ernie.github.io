...
Bitcoin trades at **\$114,250-\$114,500** as of 09:30 UTC (17:30 Taipei) on October 28, down **0.77-1.4%** over 24 hours after testing resistance near **\$116,000** on October 27. Ethereum sits at **\$4,090-\$4,124**, down **1.43-3.7%**, retreating from Monday's brief climb above **\$4,200**. The global crypto market cap stands at **\$3.86-3.95 trillion**, down **0.52-1.5%** in 24 hours.[^1][^2][^3][^4][^5][^6][^7]

Among top assets: **XRP** (\$2.63-2.66) is the only gainer in the top 10, up **0.4-1.3%**. **BNB** (\$1,131-1,140) fell **2.2-3.2%**, **SOL** (\$198-200) declined **0.17-0.29%**, **DOGE** (\$0.20) dropped **2.7%**, and **ADA** (\$0.67) slid **0.92%**. Notable outperformers: **HBAR** surged **16.3-18%** on ETF news, **TAO** +10%, **KERNEL** +15%.[^8][^4][^9][^10][^11][^7][^1]

**Derivatives:** BTC futures open interest climbed to **\$27.6 billion**, with funding rates positive at **0.0073%** (annualized ~7.99% on Binance), signaling gradual bullish momentum. ETH funding rate: **0.0044%**. 24-hour liquidations totaled **\$217-270 million**, with **71-76.6%** from long positions; ETH led with **\$97.7 million** in liquidations (**68.6%** longs), BTC **\$54-77 million**, SOL **\$13-34 million**.[^12][^13][^7][^14][^15]

**Stablecoin flows:** USDC supply reached **\$76.17 billion** (stable). Circle minted **750 million USDC** on Solana in recent hours, pushing Solana USDC supply above previous highs. USDT supply: **\$183.2 billion**.[^16][^10][^17][^8]

**Dominant narrative:** Market consolidation ahead of **FOMC rate decision** (Oct 29, 14:00 ET / Oct 30 02:00 UTC+8), with **96-98% probability** of 25bp cut to 3.75-4.00% range priced in. **Risk:** Medium—near-term caution before Fed decision and Powell press conference.[^4][^7][^18]

***

### **Top Headlines**

**1. Citi and Coinbase Partner on Digital Asset Payment Infrastructure (Oct 27, 09:00 UTC / 17:00 Taipei)**
Citigroup and Coinbase announced collaboration to develop digital asset payment capabilities for institutional clients. Initial phase focuses on fiat on/off-ramps supporting Coinbase's infrastructure and payment orchestration; future plans include 24/7 fiat-to-stablecoin conversion. Sen (Citi): "With 300+ payment clearing networks across 94 markets, this extends our 'network of networks' approach." Foster (Coinbase): "Combining Citi's reach with Coinbase's digital asset leadership simplifies access to digital asset payments." Partnership builds on Citi's existing Citi Token Services and 24/7 USD Clearing offerings.[^19][^20][^21][^22][^23][^24]
**Primary source:** [Citi press release](https://www.citigroup.com/global/news/press-release/2025/citi-coinbase-join-forces-boost-digital-asset-payment-capabilities-global-clients) | Secondary: [Reuters](https://www.reuters.com/business/finance/citi-tie-up-with-coinbase-boost-digital-payments-institutional-clients-2025-10-28/), [CoinDesk](https://www.coindesk.com/business/2025/10/27/wall-street-bank-citi-coinbase-partner-to-expand-digital-asset-payments)
**Risk:** Medium—major TradFi/crypto infrastructure integration signals institutional adoption acceleration.

**2. Bitcoin and Ethereum Spot ETFs Record \$149M and \$134M Inflows (Oct 27 data, reported Oct 28)**
US BTC spot ETFs saw **\$149 million** net inflows on October 27, the third consecutive day of positive flows. BlackRock's **IBIT** led with major inflows (week-to-date: \$324M), followed by **ARKB** (\$54M) and **FBTC** (\$52M). ETH spot ETFs recorded **\$134 million** inflows on Oct 27 after three consecutive days of outflows, with zero outflows across all nine funds—**ETHA** and **ETHW** led. October 2025 total BTC ETF inflows: **\$4.21 billion** (reversing September's \$1.23B outflows). Cumulative BTC ETF inflows: **\$61.98 billion** (6.78% of BTC market cap).[^2][^25][^26][^27][^28][^29][^30][^31]
**Primary source:** [SoSoValue data](https://farside.co.uk/btc/) | Secondary: [Yahoo Finance](https://finance.yahoo.com/news/bitcoin-etfs-score-149m-inflows-094305159.html), [Mitrade](https://www.mitrade.com/au/insights/news/live-news/article-3-1226048-20251028)
**Risk:** Low—sustained institutional demand indicator.

**3. Canary Capital Launches First US HBAR ETF; Solana ETFs Debut Imminent (Oct 28)**
Canary Capital's **HBAR ETF (Nasdaq: HBR)** began trading Oct 28 after SEC effectiveness declaration. CEO McClurg: "Hedera is built for enterprise tokenization, high-speed settlement, real-world Web3 infrastructure." Hedera's proof-of-stake network (governed by Google, IBM) processes millions of daily transactions with low fees. HBAR token surged **17-18%** on the news, with 24h volume jumping **344%** to \$871 million. Separately, **Bitwise Solana staking ETF** and **Canary Litecoin ETF** also expected to debut Oct 28 on NYSE/Nasdaq.[^7][^32][^33][^34][^35][^36]
**Primary source:** [Canary Capital press release](https://www.businesswire.com/news/home/20251028164577/en/) | Secondary: [CoinDesk](https://www.coindesk.com/markets/2025/10/28/crypto-markets-today-btc-holds-at-usd114-5k-hbar-soars-on-etf-news), [Reuters](https://www.reuters.com/legal/transactional/canary-capital-plans-launch-first-us-litecoin-hedera-spot-etfs-tuesday-2025-10-27/)
**Risk:** High—first altcoin ETF approvals beyond BTC/ETH signal major regulatory shift; expands institutional access.

**4. Metaplanet Launches \$500M Bitcoin-Backed Share Buyback (Oct 27, announced for Oct 29 start)**
Tokyo-listed Metaplanet (3350.T) approved **¥75 billion (\$500M)** share repurchase program backed by Bitcoin-collateralized credit facility. Plan: repurchase up to **150 million shares (13.13%** of float) from Oct 29, 2025 to Oct 28, 2026 on Tokyo Stock Exchange. Metaplanet holds **30,823 BTC** (\$3.5B) and targets **210,000 BTC by end-2027**. Move follows mNAV decline to **0.88x** on Oct 17 (recovered to 1.03x); stock at 499 JPY vs. 1,895 JPY peak (June 16). Credit facility avoids selling BTC to fund buyback.[^37][^38][^39][^40][^41][^42][^43]
**Primary source:** [Metaplanet board resolution / Tokyo Stock Exchange filing](https://www.coindesk.com/markets/2025/10/28/metaplanet-initiates-13-share-buyback-program-with-usd500m-credit-facility) | Secondary: [The Block](https://en.cryptonomist.ch/2025/10/28/metaplanet-buyback-tokyo-stock-exchange/), [Binance Square](https://www.binance.com/en/square/post/10-28-2025-crypto-news-today-metaplanet-launches-500m-bitcoin-backed-stock-buyback-31616673663090)
**Risk:** Medium—innovative BTC treasury capital management strategy; watch for corporate adoption replication.

**5. Trump Media Announces Prediction Markets Integration with Crypto.com (Oct 28)**
Trump Media & Technology Group (DJT) announced "Truth Predict" feature integrating prediction markets on Truth Social via exclusive partnership with Crypto.com Derivatives North America (CFTC-registered exchange). Users will trade prediction contracts on elections, Fed rate decisions, commodity prices, sports using crypto, with real-time pricing. CEO Nunes: "First publicly traded social media platform to offer prediction markets... democratizing information and empowering everyday Americans." Beta testing to begin soon; full US launch followed by global rollout. DJT shares +4.4% premarket following announcement.[^44][^37]
**Primary source:** [Trump Media press release](https://www.globenewswire.com/news-release/2025/10/28/3175429/0/en/) | Secondary: [CoinDesk](https://www.coindesk.com/markets/2025/10/28/trump-media-taps-crypto-com-to-launch-prediction-markets-on-truth-social)
**Risk:** Medium—social media/prediction market convergence; regulatory scrutiny likely.

**6. Crypto Funding Hits \$2.5B in October; 2025 Total Exceeds \$19B (Oct 17 data, circulated Oct 28)**
...
- **SEC/CFTC Harmonization (Sept 2025, ongoing):** SEC Chair Atkins and CFTC Acting Chair Pham issued joint statement on regulatory harmonization (Sept 5), announced Sept 29 roundtable. SEC Spring 2025 Regulatory Agenda (Sept 4) includes potential rules for digital asset trading, custody, transfer agents. CFTC launched "crypto sprint" initiative for spot crypto trading on DCMs; issued request for comment on tokenized collateral/stablecoins (deadline Oct 20).[^57][^58]
- **SEC Leadership:** Mike Selig (SEC crypto task force lawyer) tapped by President Trump to chair CFTC (announced Oct 26-27).[^59][^60]
- **No new enforcement actions or ETF denials reported for Oct 27-28 window.**

**European Union:**

- **MiCA:** Fully applicable since Dec 30, 2024; stablecoin rules since June 30, 2024. ESMA updated non-compliant entities register (last update Oct 27, 2025). RTS on market abuse compliance (surveillance, STOR reporting) entered force Sept 9, 2025.[^61][^62][^63][^64][^65]

**Asia-Pacific:**

- **Taiwan (FSC):** XREX Taiwan secured FSC approval for AML registration (Sept 2025), among first 9 VASPs to pass new regulatory framework; licensed for exchange, trading, transfer, custody. FSC "Taiwan Weeks 2025" held Oct 15-23 to promote asset management center initiative.[^66][^67][^68]
- **Singapore (MAS):** Finalized stablecoin framework; maintains rigorous VASP licensing. Banks introducing anti-scam safeguard starting Oct 15, 2025.[^69][^70][^57]
- **Hong Kong (SFC/HKMA):** Drafting strict stablecoin requirements; introduced licensing for OTC trading, custody.[^70][^57]

**No material government/regulatory actions reported in the Oct 21-28 window beyond ongoing policy development.**

***

### **Research & Technical Reports**

- **Binance Research (Oct 9):** "Key Trends in Crypto – October 2025" report: September market cap +4.3% on Fed rate cut; BNB +19.7% (strongest performer); BTC dominance 58.1%, ETH 13%; DeFi TVL +3% MoM; NFT sales volume -25.5%.[^71]
- **CME Group (Oct 12):** "Crypto Insights Q3 2025": Record-breaking Q3 with \$900B+ crypto futures/options volume; ADOI \$31.3B; record 1,014 large open interest holders (Sept 16 week).[^72]
- **Chainalysis (Oct 22):** "2025 Global Crypto Adoption Index" published; India and US lead global adoption; methodology now includes institutional activity sub-index (>\$1M transfers).[^73]
- **PwC (March 2025, circulated Oct):** "Global Crypto Regulation Report 2025": US shift to crypto-friendly stance; MiCA transitional period creates uncertainty; global stablecoin regulation intensifying.[^70]
- **Glassnode/Coinbase:** Q3 2025 report available (referenced Oct).[^74][^75]
- **TRM Labs (Oct 21):** "2025 Crypto Adoption and Stablecoin Usage Report" published.[^76]
- **Galaxy (Oct 22):** "Crypto Policy Under Trump: H1 2025 Report" covers regulatory accomplishments and obstacles.[^77]

**No new white papers or protocol technical updates disclosed in Oct 27-28 window.**

***

### **Security Incidents**

- **RedTiger Malware (Netskope report, Oct 27):** Open-source red teaming tool (Python-based, released 2024) weaponized into infostealer targeting gamers; steals Discord accounts, browser passwords, crypto wallets, webcam images; spread via game mods/cracked tools; uploads to GoFile; Linux/macOS variants in development. Mitigation: delete/reinstall Discord, enable 2FA, avoid unverified downloads.[^78]
- **North Korean Hackers (Google/Mandiant warning, Oct 27):** Cryptocurrency threat intelligence falling short; DPRK exploiting Web2 vulnerabilities (email, social media) rather than blockchain flaws to steal crypto for weapons programs; industry lacks sufficient defenders; blockchain transparency enables real-time tracking of stolen funds but expertise shortage persists.[^79]
- **Oracle E-Business Suite CVE-2025-61882 (FBI/CISA alert, Oct 5-28):** Critical vulnerability (CVSS 9.8) being exploited; remotely exploitable without credentials; CISA added to KEV catalog with **Oct 28 federal agency patch deadline**. Not crypto-specific but affects enterprises holding digital assets.[^80]

**No major DeFi protocol exploits or exchange hacks confirmed in Oct 27-28 window.** Chainalysis 2025 Crypto Crime Report (Jan 2025) shows 2024 illicit crypto activity at \$40.9B (lower-bound estimate, expected to rise to ~\$51B as more addresses identified).[^81][^82]

***

### **What to Watch (Next 24-72h)**

**Immediate (Oct 29, 14:00 ET / Oct 30 02:00 Taipei):**

- **FOMC Rate Decision:** 96-98% probability of 25bp cut to 3.75-4.00% range; Fed statement at 14:00 ET, Powell press conference 14:30 ET (Oct 29). Watch for forward guidance on pace of future cuts and commentary on labor market (unemployment 4.3%, core PCE 2.9%).[^48][^18][^4][^7][^47]

**Oct 30:**

- **US Q3 GDP Data:** 8:30 AM ET (20:30 Oct 29 UTC, Oct 30 04:30 Taipei); forecast +3.0%.[^47][^48]
- **Trump-Xi Meeting:** Potential US-China trade deal framework; confirmed meeting date Oct 30.[^83][^7][^48][^47]

**Oct 31:**

- **Core PCE Inflation Data:** 8:30 AM ET (20:30 UTC, Nov 1 04:30 Taipei); Fed's preferred inflation metric (MoM & YoY).[^48][^47]

**Nov 1:**

- **Token Unlocks:** SUI \$119M (43.96M tokens), EIGEN \$40.87M.[^49][^50][^51][^47][^48]

**Nov 2:**

- **Token Unlocks:** Ethena (ENA) 0.6% of circulating supply.[^51]

**ETF Launches:**

- Monitor Solana, Litecoin, HBAR ETF trading volumes and flows in first week (Oct 28 onward).[^32][^34][^35]

**Liquidation Levels:**

- BTC: \$116,000 core liquidation cluster (potential short squeeze above \$115K). Support: \$111,400-113,300.[^84][^18][^7]

**Metaplanet Buyback:**

- Begins Oct 29; monitor Tokyo Stock Exchange (3350.T) trading activity and mNAV evolution.[^38][^42][^43]

***

### **Confidence Statement**

**High confidence.** All headline items verified at primary sources (exchange/company press releases, SEC filings, official blogs, CFTC/FSC portals). Price data cross-referenced across CoinMarketCap, CoinGecko, Binance, Blockchain.com (Oct 28 09:00-12:00 UTC snapshots). ETF flow data from SoSoValue/Farside corroborated by multiple secondary sources. One item flagged: Token unlock totals aggregated from Tokenomist via KuCoin/Binance Square; primary Tokenomist data not directly accessed but widely cited across industry sources. Regulatory section draws from official .gov/.eu domains and verified legal/compliance trackers (Latham, Clifford Chance, PwC).

***

**Report compiled:** October 28, 2025, 21:15 UTC (October 29, 05:15 Asia/Taipei)
**Sources:** 148 verified (primary: 23 | secondary: 125)
**Coverage:** General news [25 items], Exchange announcements , Regulation , Research , Security , Social/Events[^3][^85][^16][^4]
<span style="display:none">[^100][^101][^102][^103][^104][^105][^86][^87][^88][^89][^90][^91][^92][^93][^94][^95][^96][^97][^98][^99]</span>
